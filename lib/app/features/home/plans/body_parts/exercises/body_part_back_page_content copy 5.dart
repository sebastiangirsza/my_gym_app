...
class BodyPartTricepsPageContent extends StatefulWidget {
  const BodyPartTricepsPageContent({
    Key? key,
  }) : super(key: key);

  @override
  State<BodyPartTricepsPageContent> createState() =>
      _BodyPartTricepsPageContentState();
}

class _BodyPartTricepsPageContentState
    extends State<BodyPartTricepsPageContent> {
  @override
