...
class BodyPartChestPageContent extends StatefulWidget {
  const BodyPartChestPageContent({
    Key? key,
  }) : super(key: key);

  @override
  State<BodyPartChestPageContent> createState() =>
      _BodyPartChestPageContentState();
}

class _BodyPartChestPageContentState extends State<BodyPartChestPageContent> {
  @override
              ...
              body: ListView(
                children: [
                  for (final document in documents) ...[
                    if (document['body_part'] == 'Klatka piersiowa') ...[
                      Padding(
