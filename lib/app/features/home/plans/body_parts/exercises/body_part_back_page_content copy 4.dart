...
class BodyPartSchouldersPageContent extends StatefulWidget {
  const BodyPartSchouldersPageContent({
    Key? key,
  }) : super(key: key);

  @override
  State<BodyPartSchouldersPageContent> createState() =>
      _BodyPartSchouldersPageContentState();
}

class _BodyPartSchouldersPageContentState
    extends State<BodyPartSchouldersPageContent> {
  @override
